# Phase 4 実装データは削除済 (2026-05-02)

本 phase (`4/study-hybrid-search-gcp/`) の **実装データ (コード)** は
...
```bash
# Phase 4 全体を復元
git checkout pre-phase3to6-impl-removal -- 4/study-hybrid-search-gcp/

# 特定ディレクトリだけ復元
git checkout pre-phase3to6-impl-removal -- 4/study-hybrid-search-gcp/app/
