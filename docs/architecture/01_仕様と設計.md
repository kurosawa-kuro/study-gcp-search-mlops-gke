...
| ID | スコープ | 主成果物 (Phase 7 配下に本実装) |
|---|---|---|
| **6A** | Composer DAG 本線化 | `infra/terraform/modules/composer/`、`pipeline/dags/{daily_feature_refresh,retrain_orchestration,monitoring_validation}.py` の 3 DAG、Vertex `PipelineJobSchedule` 完全撤去、Cloud Scheduler / Eventarc / Cloud Function trigger を本線から軽量代替へ格下げ |
